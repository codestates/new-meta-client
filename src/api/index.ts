...
const API = {
  ...
  championInfo:
    "http://ddragon.leagueoflegends.com/cdn/11.8.1/data/ko_KR/champion", // + 챔피언 영문명 ex) Bard.json
  ...
  championSquare: "http://ddragon.leagueoflegends.com/cdn/11.8.1/img/champion", // Aatrox.png
  championSpell: "http://ddragon.leagueoflegends.com/cdn/11.8.1/img/spell", // BardQ.png
};
export default API;
